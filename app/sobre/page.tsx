              ...
              >
                ...
                >
                  <nav className="flex flex-col gap-3">
                    ...
                    <Link href="/sobre" onClick={() => setMobileOpen(false)} className="text-[#FFD166] font-semibold">
                      Sobre
                    </Link>
                    <Link href="/duvidas" onClick={() => setMobileOpen(false)} className="text-white hover:text-[#FFD166] transition-colors">
                      Dúvidas
                    </Link>
                  </nav>
                </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl text-white">
            ...
            <p className="text-xl md:text-2xl text-[#FFD166] mb-8">
              Inovação e conhecimento para transformar a gestão universitária
              pública
            </p>
            <p className="text-lg leading-relaxed">
              Conheça nossa missão, valores e a história por trás desta
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-[#F8F9FA] rounded-2xl p-8 mb-8">
                <p className="text-gray-700 leading-relaxed mb-6 text-lg text-justify">
                  A InGUP360 nasceu da necessidade de enfrentar um desafio
                  recorrente nas Instituições Federais de Ensino Superior : a
                  ausência de capacitação específica para gestores que assumem
                  cargos estratégicos sem a devida preparação nos principais
                  processos da universidade. Essa lacuna impactava diretamente a
                  eficiência e a eficácia organizacional.
                </p>

                <p className="text-gray-700 leading-relaxed mb-6 text-lg text-justify">
                  Diante desse cenário, a plataforma foi concebida como uma
                  ferramenta inovadora e prática, voltada para o aprimoramento
                  da gestão universitária. Seu propósito é otimizar o tempo e os
                  recursos das instituições, ao mesmo tempo em que promove o
                  desenvolvimento contínuo de gestores por meio de conteúdos
                  direcionados, acessíveis e aplicáveis ao dia a dia da
                  administração pública universitária.
                </p>

                <p className="text-gray-700 leading-relaxed text-lg text-justify">
                  A InGUP360 reúne conceitos-chave, metodologias e boas práticas
                  de gestão, transformando conhecimento em ação e fortalecendo a
                  cultura da inovação nas universidades públicas.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 text-center shadow-lg">
                <div className="w-16 h-16 bg-[#FFD166] rounded-full flex items-center justify-center mx-auto mb-6">
                  <i className="ri-focus-3-line text-2xl text-[#1B365D]"></i>
                </div>
                <h3 className="text-2xl font-bold text-[#1B365D] mb-4">
                  Missão
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  Capacitar gestores universitários com ferramentas práticas e
                  conhecimentos específicos para otimizar a gestão das
              ...
              <div className="bg-white rounded-2xl p-8 text-center shadow-lg">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ser a principal referência em capacitação gerencial para
                  universidades públicas, promovendo a excelência e inovação na
              ...
              <div className="bg-white rounded-2xl p-8 text-center shadow-lg">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Inovação, excelência, transparência, colaboração e compromisso
                  com o desenvolvimento contínuo da gestão universitária
                  pública.
                </p>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="bg-[#F8F9FA] rounded-2xl p-8">
                  <h3 className="text-3xl font-bold text-[#1B365D] mb-6">
                    Renata Lisbôa
                  </h3>
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <p className="text-lg text-justify">
                      Renata Lisbôa é administradora e especialista em Gestão de
                      Empresas e Negócios. Servidora pública há 11 anos, acumula
                      8 anos de experiência em cargos de gestão, atuando
                      diretamente em processos administrativos e estratégicos no
                      setor público.
                    </p>

                    <p className="text-lg text-justify">
                      Atualmente, é mestranda do PROFNIT/UFOPA, onde desenvolve
                      sua pesquisa com o objetivo de expandir a temática da
                      inovação nas Ifes.
                    </p>

                    <p className="text-lg text-justify">
                      Com a criação da InGUP360, Renata busca modernizar as
                      ferramentas de capacitação voltadas aos gestores
                      universitários, promovendo a cultura da inovação e
                      transformando sua pesquisa em um produto tecnológico de
              ...
              <div className="space-y-8">
                <div>
                  <div className="flex items-start mb-4">
                    <div className="w-12 h-12 bg-[#FFD166] rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                      <i className="ri-file-text-line text-xl text-[#1B365D]"></i>
                    </div>
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed text-lg text-justify">
                        Os materiais disponibilizados nesta plataforma são de
                        uso educacional e institucional. Podem ser consultados e
                        baixados livremente, desde que citada a fonte e mantidos
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex items-start mb-4">
                    <div className="w-12 h-12 bg-[#FFD166] rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                      <i className="ri-copyright-line text-xl text-[#1B365D]"></i>
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-[#1B365D] mb-3">
                        Direitos Autorais
                      ...
                      <p className="text-gray-700 leading-relaxed text-lg text-justify mb-4">
                        Todos os conteúdos são protegidos pelas Leis nº
                        9.610/1998 (Direitos Autorais) e nº 10.973/2004 (Lei de
                        Inovação).
                      </p>
                      <p className="text-gray-700 leading-relaxed text-lg text-justify">
                        É proibida a reprodução, modificação ou uso comercial do
                        material sem autorização prévia da autora ou da UFOPA.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex items-start mb-4">
                    <div className="w-12 h-12 bg-[#FFD166] rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                      <i className="ri-refresh-line text-xl text-[#1B365D]"></i>
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-[#1B365D] mb-3">
                      ...
                      <p className="text-gray-700 leading-relaxed text-lg text-justify mb-4">
                        A plataforma poderá ser atualizada periodicamente com
                        novos conteúdos.
                      </p>
                      <p className="text-gray-700 leading-relaxed text-lg text-justify">
                        Servidores e gestores poderão sugerir materiais ou boas
                        práticas, desde que atendam aos critérios de curadoria
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex items-start mb-4">
                    <div className="w-12 h-12 bg-[#FFD166] rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                      <i className="ri-customer-service-line text-xl text-[#1B365D]"></i>
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-[#1B365D] mb-3">
                        Contato
                      ...
                      <p className="text-gray-700 leading-relaxed text-lg text-justify">
                        Dúvidas e sugestões podem ser enviadas à Progep/Ufopa ou
                        à equipe do projeto InGUP360 pelos canais
                        institucionais.
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-[#1B365D]">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-[#FFD166] mb-10 max-w-3xl mx-auto">
            Quer saber mais sobre a InGUP360 ou tem alguma sugestão? Estamos
