        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl text-white">
            ...
            <p className="text-xl md:text-2xl text-[#FFD166] mb-8">
              Na InGUP360, os materiais estão organizados por temas
              estratégicos, identificados em nossa pesquisa
            </p>
            <p className="text-lg leading-relaxed">
              Cada tema traz recursos de estudo, exemplos práticos e ferramentas
              de apoio.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Conteúdos estruturados para desenvolver competências específicas
              na gestão universitária pública.
            </p>
          </div>

          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto ">
            {/* Planejamento */}
            <div className="bg-[#F8F9FA] rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-200 flex flex-col">
              ...
              <p className="text-gray-600 leading-relaxed mb-8 flex-grow">
                Fundamentos e práticas para organização e execução de planos de
                gestão.
              </p>
              <Link href="/planejamento">
                <button className="bg-[#4F81C7]  w-full  text-white px-6 py-3 rounded-lg hover:bg-[#4F81C7]/90 transition-colors cursor-pointer whitespace-nowrap font-semibold">
                  Acessar Conteúdo
                </button>
              </Link>
            </div>
            ...
            <div className="bg-[#F8F9FA] rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-200 flex flex-col">
              ...
              <p className="text-gray-600 leading-relaxed mb-8 flex-grow">
                Estratégias para liderança de equipes e desenvolvimento de
                talentos.
              </p>
              <Link href="https://drive.google.com/file/d/1leoL6qqsNg6ihrEUs1234q1ELeFqo0_c/view?usp=drive_link" target="_blank">
                <button className="bg-[#4F81C7] w-full text-white px-6 py-3 rounded-lg hover:bg-[#4F81C7]/90 transition-colors cursor-pointer whitespace-nowrap font-semibold">
                  Acessar Conteúdo
                </button>
              </Link>
            ...
            <div className="bg-[#F8F9FA] rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-200 flex flex-col">
              ...
              <p className="text-gray-600 leading-relaxed mb-8 flex-grow">
                Habilidades para enfrentar desafios e conduzir processos
                acadêmicos.
              </p>
              <Link href="/lideranca">
              <button className="bg-[#4F81C7] w-full text-white px-6 py-3 rounded-lg hover:bg-[#4F81C7]/90 transition-colors cursor-pointer whitespace-nowrap font-semibold">
            ...
            <div className="bg-[#F8F9FA] rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-200 flex flex-col">
              ...
              <Link href="https://drive.google.com/file/d/15tb4ZjTHLivVq-BQFQbKjmyGIJMOyHH-/view?usp=sharing " target="_blank">
              <button className="bg-[#4F81C7] w-full text-white px-6 py-3 rounded-lg hover:bg-[#4F81C7]/90 transition-colors cursor-pointer whitespace-nowrap font-semibold">
                Acessar Conteúdo
              </button>
              </Link>
            ...
            <div className="bg-[#F8F9FA] rounded-2xl p-8 hover:shadow-lg transition-shadow border border-gray-200">
              ...
              <Link href="https://drive.google.com/file/d/1DGPocjEaOvx6W21FNhzeBev6nG8lEHz4/view?usp=drive_link" target="_blank">
              <button className="bg-[#4F81C7] w-full text-white px-6 py-3 rounded-lg hover:bg-[#4F81C7]/90 transition-colors cursor-pointer whitespace-nowrap font-semibold">
                Acessar Conteúdo
              </button>
              </Link>
      ...
      <section className="py-20 bg-[#1B365D]">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-[#FFD166] mb-10 max-w-3xl mx-auto">
            Explore os materiais didáticos e transforme sua gestão universitária
            com conteúdo especializado
          </p>
        </div>
      </section>
